...
/*   Updated: 2024/11/07 12:03:27 by brandebr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
		...
		sleep(2);
		std::cout << "Zaphood: " << GREEN << "Well, my bad..., my apologies " << s->getName() << ", I should have known, I will ask a higher ranking officer. " << std::endl << YELLOW << m->getName() << " could you do the job? "<< RESET << std::endl;
		sleep(2);
		try {
		...
		sleep(3);
		std::cout << "Prostetnic Vogon Jeltz: This is Prostetnic Vogon Jeltz of the Galactic Hyperspace Planning Council. " << std::endl; 
		sleep(3);
		...
		sleep(4);
		std::cout << "The process will take slightly less than two of your Earth minutes. Thank you." << std::endl;
		sleep(5);
