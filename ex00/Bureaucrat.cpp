...
/*   Updated: 2024/11/13 11:20:51 by brandebr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "Bureaucrat.hpp"

Bureaucrat::Bureaucrat() : _name("Mr. Prosser"), _grade(LOWEST) {
	std::cout << this->_name << " has been employed at the lowest grade with default clerk constructor and grade: " << this->_grade << "." << std::endl;
}
