...
{
	std::string user;
	std::cout << BLUE << "Somwhere in the headoffices of Vogsphere, the President of the Galaxy, Zaphood Beeblebrox is welcoming a new head of the intergalactical Construction department. "<< std::endl << RESET << "Zaphood Beeblebrox: " << GREEN << "My apologies, but, what was your name again? " << std::endl << RESET; 
	...
	sleep(2);
	std::cout << "But before anything,.. office routine requires the creation of some forms to start off the day .." << std::endl;
	sleep(2);
	AForm* forms[4];
